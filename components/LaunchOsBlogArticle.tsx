...
const blogCopy: Record<Locale, BlogCopy> = {
  zh: {
    ...
    subtitle: "maclaunchpad 是 macOS 26 的免费 Launchpad 替代方案。",
    lead:
      "Spotlight 很好，但很多人依然需要启动台。我们需要的不只是搜索框，还需要一种更直观、更有秩序、更符合使用习惯的方式来打开应用。maclaunchpad 正是为此而生。",
    metadataTitle: "maclaunchpad 博客 | 免费的 Web 版 macOS Launchpad 替代方案",
    metadataDescription:
      "了解 maclaunchpad 如何用免费的 Web 方式，还原 macOS Launchpad 的熟悉体验，并尊重用户长期形成的操作习惯。",
    highlights: [
      {
        title: "免费",
    ...
    sections: [
      ...
      },
      {
        heading: "为什么选择 Web 版",
        paragraphs: [
          "我们希望 maclaunchpad 足够轻，足够快，也足够容易上手。于是我们选择了 Web 形态：打开即用，免费可访问，不要求用户先学习一套新的桌面工具逻辑。",
      ...
      },
      {
        ...
        paragraphs: [
          "maclaunchpad 的目标不是简单做一个图标网格，而是尽量还原用户熟悉的使用路径。你打开页面后，不需要重新理解信息架构；视觉重心、浏览方式、点击逻辑，都会尽可能贴近 Launchpad 本身。",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "有些人偏爱键盘搜索，有些人更依赖图形浏览；有些人记得应用名，有些人只记得图标在哪。maclaunchpad 不试图否定 Spotlight，而是承认 Launchpad 仍然有存在价值，并为这类用户提供一个免费的、方便的、足够熟悉的选择。",
        ],
      },
      {
        heading: "为我们自己做，也为和我们一样的人做",
        paragraphs: [
          "我们做 maclaunchpad，首先是因为自己需要它。Spotlight 很棒，但我们仍然离不开 Launchpad 带来的秩序感和掌控感。既然这种需求真实存在，就值得被认真对待。",
          "所以这不只是一个怀旧项目，而是一个面向真实使用场景的产品尝试。如果你也在寻找 macOS 26 Tahoe 下更自由、更熟悉的 Launchpad 替代方案，那么 maclaunchpad 也许正适合你。",
        ],
      },
    ],
    ctaLabel: "打开 maclaunchpad",
    backLabel: "返回首页",
  },
  en: {
    eyebrow: "Free on the web, familiar on your Mac",
    title: "The Launchpad you know, refined for macOS 26 Tahoe",
    subtitle: "maclaunchpad is a free Launchpad alternative for macOS 26.",
    lead:
    ...
    metadataTitle: "maclaunchpad Blog | A free web Launchpad alternative for macOS",
    metadataDescription:
      "See how maclaunchpad brings back the familiar Launchpad experience in a free web app while respecting the habits Mac users already rely on.",
    highlights: [
      {
        title: "Free",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "We wanted maclaunchpad to be light, fast, and easy to start using. That is why we chose the web. It is free, immediately accessible, and does not ask users to learn or maintain another complex desktop replacement.",
      ...
      },
      {
        ...
        paragraphs: [
          "maclaunchpad is not trying to build just another icon grid. We are trying to bring back a familiar interaction model. When the page opens, the visual hierarchy, browsing pattern, and launch flow should feel intuitive if you already know Launchpad.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Some people love keyboard search. Others think spatially and visually. Some remember app names, and others remember where an icon lives. maclaunchpad does not argue against Spotlight. It simply acknowledges that Launchpad still matters, and offers a free and convenient option for the people who want it.",
        ],
      },
      {
        heading: "Built for ourselves, and for people like us",
        paragraphs: [
          "We built maclaunchpad because we wanted it ourselves. Spotlight is excellent, but we still rely on the order and comfort that Launchpad provides. When a need is real, it deserves a thoughtful product response.",
          "So this is not just a nostalgic experiment. It is a practical tool for real daily use on macOS 26 Tahoe. If you want a freer, simpler, and more familiar Launchpad alternative, maclaunchpad was made for you too.",
        ],
      },
    ],
    ctaLabel: "Open maclaunchpad",
    backLabel: "Back to home",
  },
  ja: {
    eyebrow: "無料の Web 版で、使い慣れた Launchpad 体験を",
    title: "見慣れた Launchpad を macOS 26 Tahoe 向けに磨き直しました",
    subtitle: "maclaunchpad は macOS 26 向けの無料 Launchpad 代替ツールです。",
    lead:
      "Spotlight は素晴らしい存在ですが、それでも Launchpad を必要とする人は少なくありません。必要なのは検索窓だけではなく、アプリをより視覚的に、より自然に開ける方法です。maclaunchpad はそのために生まれました。",
    metadataTitle: "maclaunchpad ブログ | macOS 向け無料 Web Launchpad 代替ツール",
    metadataDescription:
      "maclaunchpad が無料の Web アプリとして Launchpad の体験をどう再現し、Mac ユーザーの習慣をどう尊重しているかを紹介します。",
    highlights: [
      {
        title: "無料",
    ...
    sections: [
      ...
      },
      {
        heading: "なぜ Web 版なのか",
        paragraphs: [
          "maclaunchpad では、軽さ、速さ、始めやすさを大切にしました。そのために選んだのが Web です。無料で使え、すぐにアクセスでき、複雑なデスクトップ代替アプリを新たに管理する必要もありません。",
      ...
      },
      {
        ...
        paragraphs: [
          "maclaunchpad が目指しているのは、単なるアイコンの並びではありません。Launchpad を知っている人が見たときに、視線の流れ、探し方、起動までの流れが自然に感じられることを重視しています。",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "キーボード検索を好む人もいれば、視覚的に探す人もいます。アプリ名で覚えている人もいれば、アイコンの場所で覚えている人もいます。maclaunchpad は Spotlight を否定しません。そのうえで、Launchpad を必要とする人のために、無料で便利で親しみやすい選択肢を用意します。",
        ],
      },
      {
        heading: "自分たちのために作り、同じ感覚を持つ人に届けたい",
        paragraphs: [
          "maclaunchpad を作った最初の理由は、自分たち自身が必要としていたからです。Spotlight が優れていても、Launchpad がもたらす整理された感覚と安心感は、やはり代えがたいものでした。",
          "だからこれは単なる懐古的なプロジェクトではありません。macOS 26 Tahoe の日常的な利用に向けた、実用的な選択肢です。より自由で、より簡単で、より馴染みのある Launchpad 代替を探しているなら、maclaunchpad はそのために作られています。",
        ],
      },
    ],
